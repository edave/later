...
later.js: $(shell node_modules/.bin/smash --list src/later.js)
	@rm -f $@
	node_modules/.bin/smash src/later.js | node_modules/.bin/uglifyjs --compress --mangle -o $@
	@chmod a-w $@
...
later-core.js: $(shell node_modules/.bin/smash --list src/later-core.js)
	@rm -f $@
	node_modules/.bin/smash src/later-core.js | node_modules/.bin/uglifyjs --compress --mangle -o $@
	@chmod a-w $@
